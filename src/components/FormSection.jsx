...
function FormSection() {
    ...
    try {
        ...
        if (data) {
            ...
            return (
                <section id="form-container" className='w-3/4 h-2/3 rounded-2xl mx-auto bg-white pt-7'>
                    <h3 className='font-bold text-center text-purple-500 text-3xl pb-7'>{username? username: "Username"} Profile</h3>
